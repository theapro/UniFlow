    ...
    <div className="container max-w-7xl py-10 space-y-12">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Tizimdagi modellarni boshqarish va foydalanuvchilar uchun ruxsatlarni
          sozlash.
        </p>
      </div>
                        ...
                        <TableRow key={m.id} className="group">
                          ...
                          <TableCell className="text-right">
                            <Switch
                              ...
                              disabled={
                                !m.isEnabled || updateMutation.isPending
                              }
                              onCheckedChange={(v) =>
                                handleUpdate(m.id, { enabledForUsers: v })
                              }
                            />
                          </TableCell>
                        </TableRow>
